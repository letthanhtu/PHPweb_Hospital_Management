...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            $error='<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Đã có tài khoản cho địa chỉ Email này.</label>';
        }else{
            
            $database->query("insert into doctor(docemail,docname,docpassword, docadress, docnic, docdob, doctel) values('$email','$name','$newpassword','$address','$nic','$dob','$tele');");
      ...
      <table border="0" style="width: 69%;">
        <tr>
          <td colspan="2">
            ...
            <p class="sub-text">Tạo tài khoản ngay bây giờ</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2">
            ...
            <a href="doctorlogin.php" class="hover-link1 non-style-link">Đăng nhập</a>
            <br><br><br>
          </td>
        </tr>
